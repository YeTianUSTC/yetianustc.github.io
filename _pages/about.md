...
I am currently a (last year) **graduate student** at the [School of Computer Science and Technology](http://cs.ustc.edu.cn/main.htm), [University of Science and Technology of China](https://www.ustc.edu.cn/) (I will graduate in **June 2024**), and my advisor is [***IEEE/ACM Fellow*** **Prof. Xiang-Yang Li**](https://scholar.google.com/citations?user=JURtNb0AAAAJ&hl=en&oi=ao). I received my bachelor's degree from Northwest Agriculture and Forestry University in 2021 with Outstanding Graduate Honors. I won the Tang Lixin Scholarship （Top 1%）and the honor of the top 10 scientific research Stars among the 100 campus Stars of the whole university.

My current research interests mainly lie in human-computer interaction, as well as mobile and ubiquitous computing, e.g., using ubiquitous wearable sensors to design advanced HCI interfaces. Our core aim is to empower objects to go beyond existing interaction types to address our real-world needs in specific scenarios. Therefore, I'm also broadly interested in the cross-application of these innovations in other areas. 

Recently, we designed a lip-reading-based authentication system (**BackLip**, **IWQoS 2023**) and a gesture-interactive mobile system on a smartwatch (**Mudra**, **INFOCOM 2022**) that combines the advantages of visual and IMU signal. We also cared about some of the needs in smart health and designed a silent speech interface, which can help those with hearing loss and speech impairments to communicate by recognizing what they lip-read. It can also extend voice assistants to those with limitations. The study is under revision review by **ACM IMWUT 2023**. Some other studies are under review, e.g., **MobiCom 2024**, **INFOCOM 2024**, etc. In these studies, I'm very honored to work with some outstanding professors, especially [***IEEE Fellow*** **Prof. Yusheng Ji**](https://scholar.google.com/citations?user=3EK_RaQAAAAJ&hl=en) (NII), **[Prof. ChenrenXu](https://scholar.google.com/citations?user=IFX5C-cAAAAJ&hl=en)** (Peking University), **Assistant Prof. Haohua Du** (BUAA), **[Prof. Hao Zhou](https://scholar.google.com/citations?user=JMfB4CIAAAAJ&hl=en)** (USTC) and **[Prof. Jiahui Hou](https://scholar.google.com/citations?user=z2gblvQAAAAJ&hl=en)** (USTC).
