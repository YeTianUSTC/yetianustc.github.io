...
Recently, we designed a lip-reading-based authentication system (**BackLip**, **IWQoS 2023**) and a gesture-interactive mobile system on a smartwatch (**Mudra**, **INFOCOM 2022**) that combines the advantages of visual and IMU signal. I am very interested in the contribution of intelligent interaction in human health, especially for those who are vulnerable and marginalized. I have designed a silent voice interface based on wireless signals that helps those with hearing loss and speech impairments to communicate better through lip-reading. It is under revision on **ACM IMWUT 2023**. Some other studies have been submitted to the top conferences in the field of mobile computing and networking, e.g., **MobiCom 2024** and **INFOCOM 2024**. In these studies, I'm very honored to collaborate with some distinguished professor, especially [***IEEE Fellow*** **Prof. Yusheng Ji**](https://scholar.google.com/citations?user=3EK_RaQAAAAJ&hl=en) (NII), **[Prof. ChenrenXu](https://scholar.google.com/citations?user=IFX5C-cAAAAJ&hl=en)** (Peking University), Assistant Prof. Haohua Du, **[Prof. Hao Zhou](https://scholar.google.com/citations?user=JMfB4CIAAAAJ&hl=en)** and **[Prof. Jiahui Hou](https://scholar.google.com/citations?user=z2gblvQAAAAJ&hl=en)** (USTC). 

In my undergraduate years, I was a member of the Intelligent Information Processing Laboratory co-led by **[Prof. Yong Deng](https://scholar.google.com/citations?user=Zuhod6sAAAAJ&hl=en&oi=ao)** and **[Prof. Bingyi Kang](https://scholar.google.com/citations?user=VIEDOvoAAAAJ&hl=en)**. I focus on human-centered computing, especially decision-making and control algorithms in uncertain environments. I have led a number of exciting studies that have been published in the top journals in the field, including **IEEE Transactions on Fuzzy Systems**, **Applied Soft Computing**, and so on. I am very happy that these studies have received a lot of attention and praise from other peers, including [the fellow of the Royal Society of Canada **Prof. Witold Pedrycz** (***Life Fellow, IEEE***)](https://scholar.google.com/citations?user=0nrcfZwAAAAJ&hl=en&oi=ao).  We were collaborated on the design of a decision-making framework. It is under revision on **Expert Systems with Application**, a top journal in this field.
...
- *2023.10*,    **National Scholarship**, (**ranking 1%**)
